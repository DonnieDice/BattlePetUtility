...
function addon:GetPetJournalSearchBox()
	if(PetJournalSearchBox) then return PetJournalSearchBox end
	if(PetJournal and PetJournal.searchBox) then return PetJournal.searchBox end
	if(CollectionsJournal and CollectionsJournal.PetJournal and CollectionsJournal.PetJournal.searchBox) then
		return CollectionsJournal.PetJournal.searchBox;
	end
...
function addon:ResetJournalFiltering()
	local searchBox = addon:GetPetJournalSearchBox();
	...
	savedJournalFilters.search = searchBox:GetText();
	searchBox:SetText("");
...
function addon:RestoreJournalFiltering()
	...
	if(searchBox) then
		...
		searchBox:SetText(savedJournalFilters.search or "");
	end
end
...
function addon:UpdateWoundedText()
	if(not addon.PetHealer or not addon.PetHealer.GossipID) then return end
